...
const availableModels = {
    google: [
        { id: 'googleai/gemini-2.5-pro', name: 'Gemini 2.5 Pro (Bilder & Text)' },
        { id: 'googleai/gemini-2.5-flash', name: 'Gemini 2.5 Flash (Schnell & Text)' },
        { id: 'googleai/gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite (Sehr schnell & Text)' },
    ],
    openrouter: [
